...
give @s oak_sign{display:{Name:'{"text":"Team: Green"}'},BlockEntityTag:{Color:"gray",GlowingText:1b,Text1:'{"text":"Join the","color":"#bdfc00"}',Text2:'{"text":"Green Team","color":"#bdfc00"}',Text3:'{"text":"","color":"#bdfc00","clickEvent":{"action":"run_command","value":"/function signs:lobby/team_panel/green/execute/driver"}}',Text4:'{"text":"Right click","color":"yellow"}'}}

give @s oak_sign{display:{Name:'{"text":"Team: Blue"}'},BlockEntityTag:{Color:"gray",GlowingText:1b,Text1:'{"text":"Join the","color":"#00ffff"}',Text2:'{"text":"Blue Team","color":"#00ffff"}',Text3:'{"text":"","color":"#00ffff","clickEvent":{"action":"run_command","value":"/function signs:lobby/team_panel/blue/execute/driver"}}',Text4:'{"text":"Right click","color":"yellow"}'}}
...
give @s oak_sign{display:{Name:'{"text":"Teleport: Options"}'},BlockEntityTag:{Color:"gray",GlowingText:1b,Text1:'{"text":"Right click this","color":"white"}',Text2:'{"text":"to teleport","color":"white"}',Text3:'{"text":"","color":"white","clickEvent":{"action":"run_command","value":"/function teleports:lobby/options/driver"}}',Text4:'{"text":"Right click","color":"yellow"}'}}

give @s oak_sign{display:{Name:'{"text":"Teleport: Puzzle"}'},BlockEntityTag:{Color:"gray",GlowingText:1b,Text1:'{"text":"Right click this","color":"white"}',Text2:'{"text":"to teleport","color":"white"}',Text3:'{"text":"","color":"white","clickEvent":{"action":"run_command","value":"/function teleports:lobby/puzzle/driver"}}',Text4:'{"text":"Right click","color":"yellow"}'}}
