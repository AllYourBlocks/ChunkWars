...
give @s oak_sign{display:{Name:'{"text":"Teleport: Museum"}'},BlockEntityTag:{Color:"gray",GlowingText:1b,Text1:'{"text":"Teleport to","color":"white"}',Text2:'{"text":"Museum","color":"white"}',Text3:'{"text":"","color":"white","clickEvent":{"action":"run_command","value":"/function teleports:lobby/museum/driver"}}',Text4:'{"text":"Right click","color":"yellow"}'}}
