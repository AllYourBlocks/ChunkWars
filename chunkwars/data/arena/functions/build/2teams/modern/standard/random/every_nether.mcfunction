...
execute as @e[tag=read_yellow] at @s run function teleports:ram/2teams/modern/3
execute as @e[tag=read_blue] at @s run function teleports:ram/2teams/modern/3
...
execute as @e[tag=read_yellow] at @s run function teleports:ram/2teams/modern/14
execute as @e[tag=read_blue] at @s run function teleports:ram/2teams/modern/14
...
execute as @e[tag=read_yellow] at @s run function teleports:ram/2teams/modern/4
execute as @e[tag=read_blue] at @s run function teleports:ram/2teams/modern/4
