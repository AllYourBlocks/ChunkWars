#> arena:build/2teams/modern/condensed/random/yellow_nether
...
execute as @e[tag=read_yellow] at @s run function teleports:memory/2teams/modern/3
...
execute as @e[tag=read_blue] at @s run function teleports:memory/2teams/modern/14
...
execute as @e[tag=read_yellow] at @s run function teleports:memory/2teams/modern/4
