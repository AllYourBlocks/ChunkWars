...
summon marker -16 40 3056 {Tags:["paste_blue"]}
summon marker 15 40 3087 {Tags:["paste_yellow"]}
...
execute as @e[tag=paste_blue] at @s run tp @s -16 40 3056
execute as @e[tag=paste_yellow] at @s run tp @s 15 40 3087
