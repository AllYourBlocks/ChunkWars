...
execute if score $teams gamestate matches 2 if score $map_size gamestate matches 0 if score $map_condensed map_variation matches 0 run schedule function arena:build/2teams/modern/standard/end 2s
execute if score $teams gamestate matches 2 if score $map_size gamestate matches 0 unless score $map_condensed map_variation matches 0 run schedule function arena:build/2teams/modern/condensed/end 2s
