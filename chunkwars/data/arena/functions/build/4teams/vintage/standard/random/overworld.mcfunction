...
execute as @e[tag=read_blue] run tp 0 39 7152
execute as @e[tag=read_yellow] run tp 31 39 7183
execute as @e[tag=read_red] run tp 31 39 7152
execute as @e[tag=read_green] run tp 0 39 7183
execute as @e[tag=paste_blue] run tp -16 39 7152
execute as @e[tag=paste_yellow] run tp 15 39 7183
execute as @e[tag=paste_red] run tp 15 39 7152
execute as @e[tag=paste_green] run tp -16 39 7183
