...
execute unless score $teams gamestate matches 2 if score $stage gamestate matches 0..3 unless score $stage gamestate matches 1..2 run data modify block ~ ~ ~ front_text.messages[0] set value '{"text":"Join the","color":"#bdfc00"}'
execute unless score $teams gamestate matches 2 if score $stage gamestate matches 0..3 unless score $stage gamestate matches 1..2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":"Green Team","color":"#bdfc00"}'
