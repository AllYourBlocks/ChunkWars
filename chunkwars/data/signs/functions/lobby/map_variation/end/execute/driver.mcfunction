...
execute if score $stage gamestate matches 0..3 if score $teams gamestate matches 2 unless score $map_size gamestate matches 0 run function signs:lobby/map_variation/end/execute/fail/map_size

execute if score $stage gamestate matches 0..3 if score $teams gamestate matches 2 if score $map_size gamestate matches 0 run function signs:lobby/map_variation/end/execute/success
