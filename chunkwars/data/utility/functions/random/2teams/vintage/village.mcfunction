...
scoreboard players operation village random %= $int_15 integers
...
execute if score found_village random matches 1 run function utility:random/2teams/vintage/village
