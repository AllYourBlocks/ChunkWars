...
scoreboard players operation badlands random %= $int_11 integers
...
execute if score found_badlands random matches 1 run function utility:random/2teams/vintage/badlands
