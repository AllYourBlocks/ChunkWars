...
scoreboard players operation ocean random %= $int_11 integers
...
execute if score found_ocean random matches 1 run function utility:random/2teams/vintage/ocean
