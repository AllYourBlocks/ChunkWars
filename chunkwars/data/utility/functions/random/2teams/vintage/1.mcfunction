#> utility:random/2teams/vintage/1
...
scoreboard players operation pos1 random = random random
scoreboard players operation pos1 random %= $int_11 integers

scoreboard players add loops random 1


scoreboard players set reserved_pos1 random 0

execute if score reserved_pos1 random matches 0 if score pos1 random = pos0 chunk_position run scoreboard players set reserved_pos1 random 1

# if we found a collision, try again, this will increase the depth
execute if score reserved_pos1 random matches 1 run function utility:random/2teams/vintage/1
...
execute if score loops random matches 0 run scoreboard players operation pos1 chunk_position = pos1 random
