#> utility:random/2teams/vintage/10
...
scoreboard players operation pos10 random %= $int_11 integers
...
execute if score reserved_pos10 random matches 1 run function utility:random/2teams/vintage/10
