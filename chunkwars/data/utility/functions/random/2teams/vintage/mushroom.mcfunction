...
scoreboard players operation mushroom random %= $int_11 integers
...
execute if score found_mushroom random matches 1 run function utility:random/2teams/vintage/mushroom
