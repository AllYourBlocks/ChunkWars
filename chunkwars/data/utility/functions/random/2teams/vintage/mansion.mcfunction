...
scoreboard players operation mansion random %= $int_11 integers
...
execute if score found_mansion random matches 1 run function utility:random/2teams/vintage/mansion
