...
scoreboard players operation flower_forest random %= $int_11 integers
...
execute if score found_flower_forest random matches 1 run function utility:random/2teams/vintage/flower_forest
