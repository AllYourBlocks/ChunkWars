#> utility:random/2teams/modern/9
...
scoreboard players operation pos9 random %= $int_15 integers
...
execute if score reserved_pos9 random matches 1 run function utility:random/2teams/modern/9
