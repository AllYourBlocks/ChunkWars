...
scoreboard players operation fortress random %= $int_15 integers
...
execute if score found_fortress random matches 0 if score fortress random = swamp chunk_position run scoreboard players set found_fortress random 1
execute if score found_fortress random matches 0 if score fortress random = ocean chunk_position run scoreboard players set found_fortress random 1
execute if score found_fortress random matches 0 if score fortress random = ice_spikes chunk_position run scoreboard players set found_fortress random 1
execute if score found_fortress random matches 0 if score fortress random = mushroom chunk_position run scoreboard players set found_fortress random 1
...
execute if score found_fortress random matches 0 if score fortress random = nether chunk_position run scoreboard players set found_fortress random 1
execute if score found_fortress random matches 0 if score fortress random = badlands chunk_position run scoreboard players set found_fortress random 1
...
execute if score found_fortress random matches 1 run function utility:random/2teams/modern/fortress
