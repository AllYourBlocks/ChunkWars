#> utility:random/2teams/modern/4
...
scoreboard players operation pos4 random %= $int_15 integers
...
execute if score reserved_pos4 random matches 1 run function utility:random/2teams/modern/4
