...
scoreboard players operation nether random %= $int_15 integers
...
execute if score found_nether random matches 1 run function utility:random/2teams/modern/nether
