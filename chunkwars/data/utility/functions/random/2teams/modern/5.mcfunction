#> utility:random/2teams/modern/5
...
scoreboard players operation pos5 random %= $int_15 integers
...
execute if score reserved_pos5 random matches 1 run function utility:random/2teams/modern/5
