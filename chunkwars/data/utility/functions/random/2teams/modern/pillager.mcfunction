...
scoreboard players operation pillager random %= $int_15 integers
...
execute if score found_pillager random matches 0 if score pillager random = swamp chunk_position run scoreboard players set found_pillager random 1
execute if score found_pillager random matches 0 if score pillager random = ocean chunk_position run scoreboard players set found_pillager random 1
execute if score found_pillager random matches 0 if score pillager random = ice_spikes chunk_position run scoreboard players set found_pillager random 1
execute if score found_pillager random matches 0 if score pillager random = mushroom chunk_position run scoreboard players set found_pillager random 1
...
execute if score found_pillager random matches 0 if score pillager random = nether chunk_position run scoreboard players set found_pillager random 1
execute if score found_pillager random matches 0 if score pillager random = badlands chunk_position run scoreboard players set found_pillager random 1

# if we found a collision, try again, this will increase the depth
execute if score found_pillager random matches 1 run function utility:random/2teams/modern/pillager
