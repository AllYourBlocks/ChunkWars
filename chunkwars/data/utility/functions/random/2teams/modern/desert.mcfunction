...
scoreboard players operation desert random %= $int_15 integers
...
execute if score found_desert random matches 1 run function utility:random/2teams/modern/desert
