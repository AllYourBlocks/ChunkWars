...
scoreboard players operation flower_forest random %= $int_7 integers
...
execute if score found_flower_forest random matches 1 run function utility:random/4teams/vintage/flower_forest
