...
scoreboard players operation desert random %= $int_7 integers
...
execute if score found_desert random matches 1 run function utility:random/4teams/vintage/desert
