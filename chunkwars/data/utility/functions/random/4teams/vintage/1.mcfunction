#> utility:random/4teams/vintage/1
...
scoreboard players operation pos1 random %= $int_5 integers
...
execute if score reserved_pos1 random matches 1 run function utility:random/4teams/vintage/1
