...
scoreboard players operation mansion random %= $int_7 integers
...
execute if score found_mansion random matches 1 run function utility:random/4teams/vintage/mansion
