#> utility:random/4teams/vintage/2
...
scoreboard players operation pos2 random %= $int_5 integers
...
execute if score reserved_pos2 random matches 1 run function utility:random/4teams/vintage/2
