#> utility:random/4teams/vintage/4
...
scoreboard players operation pos4 random %= $int_5 integers
...
execute if score reserved_pos4 random matches 1 run function utility:random/4teams/vintage/4
