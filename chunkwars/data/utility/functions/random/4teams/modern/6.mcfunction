#> utility:random/4teams/modern/6
...
scoreboard players operation pos6 random %= $int_7 integers
...
execute if score reserved_pos6 random matches 1 run function utility:random/4teams/modern/6
