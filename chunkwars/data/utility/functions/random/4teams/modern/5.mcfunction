#> utility:random/4teams/modern/5
...
scoreboard players operation pos5 random %= $int_7 integers
...
execute if score reserved_pos5 random matches 1 run function utility:random/4teams/modern/5
