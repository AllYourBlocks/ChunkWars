#> utility:random/4teams/modern/0
...
scoreboard players operation pos0 random %= $int_7 integers
...
execute if score reserved_pos0 random matches 1 run function utility:random/4teams/modern/0
