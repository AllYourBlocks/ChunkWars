#> utility:random/4teams/modern/1
...
scoreboard players operation pos1 random %= $int_7 integers
...
execute if score reserved_pos1 random matches 1 run function utility:random/4teams/modern/1
