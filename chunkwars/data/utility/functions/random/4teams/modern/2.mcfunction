#> utility:random/4teams/modern/2
...
scoreboard players operation pos2 random %= $int_7 integers
...
execute if score reserved_pos2 random matches 1 run function utility:random/4teams/modern/2
