...
execute unless score $friendly_fire option matches -2147483648..2147483647 run scoreboard players set $friendly_fire option 1
...
#define score_holder $friendly_fire
