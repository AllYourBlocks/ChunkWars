...
kill @e[type=!minecraft:player,type=!minecraft:item,type=!end_crystal,type=!marker,type=!minecraft:chest_minecart,type=!ender_pearl,type=!arrow,x=-50,y=-64,z=-75,dx=100,dy=64,dz=150]
