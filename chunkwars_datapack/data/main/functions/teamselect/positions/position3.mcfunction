execute if entity @a[team=!spectators,x=2,y=19,z=72,distance=..2] run tag @a[team=!spectators,x=2,y=19,z=72,distance=..2] add selected

function main:teamselect/move_player_to_team

setblock 1 19 60 minecraft:oak_button[face=wall,facing=north,powered=false] replace

tag @p[tag=teamselect_3] remove teamselect_3
