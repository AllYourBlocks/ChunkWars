execute if entity @a[team=!spectators,x=5,y=19,z=44,distance=..2] run tag @a[team=!spectators,x=5,y=19,z=44,distance=..2] add selected

function main:teamselect/move_player_to_team

setblock 6 19 55 minecraft:oak_button[face=wall,facing=south,powered=false] replace
