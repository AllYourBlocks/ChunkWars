execute if entity @a[team=!spectators,x=-10,y=19,z=72,distance=..2] run tag @a[team=!spectators,x=-10,y=19,z=72,distance=..2] add selected

function main:teamselect/move_player_to_team

setblock -11 19 60 minecraft:oak_button[face=wall,facing=south,powered=false] replace
