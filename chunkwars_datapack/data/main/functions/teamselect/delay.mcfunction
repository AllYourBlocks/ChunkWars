...
execute if score playercount.var vars matches 4.. run scoreboard players set @e[name=lobby.teamselect.delay.var] 0
...
execute if score playercount.var vars matches 4.. run scoreboard players set @e[name=lobby.teamselect.delay.var] 1
