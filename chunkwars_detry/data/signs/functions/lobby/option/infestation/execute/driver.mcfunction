...
execute if entity @s[tag=MarkerRepositioner] run kill @e[type=marker,tag=OptionInfestation]
execute if entity @s[tag=MarkerRepositioner] run summon minecraft:marker ~ ~ ~ {Tags:["Option","OptionInfestation"]}