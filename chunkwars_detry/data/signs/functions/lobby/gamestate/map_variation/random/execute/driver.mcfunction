...
execute if entity @s[tag=MarkerRepositioner] run kill @e[type=marker,tag=GamestateMapSelectionRandom]
execute if entity @s[tag=MarkerRepositioner] run summon minecraft:marker ~ ~ ~ {Tags:["GamestateMapSelectionRandom"]}