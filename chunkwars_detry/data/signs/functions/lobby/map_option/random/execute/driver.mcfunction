execute unless score $stage gamestate matches 0 run function signs:lobby/map_option/random/execute/fail
execute if score $stage gamestate matches 0 run function signs:lobby/map_option/random/execute/success
